...
export const initialOrgs: Org[] = [
  { id: 1, category: 'nationState', flavor: { name: 'Human Republic', color: '#3498db', nameList: 'default'}, government: { succession: 'monarchy', leaderTermDuration: 0, presentTermEnd: 0, homeSystem: 1 }, resources: { credits: 100, rocks: 0, gas: 0 }, ownedPlanetoids: [102], characters: {characterPool: [], leaderId: null}, parentId: null, childIds: [], diplomacy: {relations: {2: { targetOrgId: 2, status: 'war', opinion: -100 }, 3: { targetOrgId: 3, status: 'war', opinion:-100}}, incomingRequests: [], residentDiplomats: []}, contextHistory: {previousIncome: { credits: 100, rocks: 0, gas: 0 }, buildPlan: [], targetSystems: [] }, research: { researched: [], researchBonuses: { depositSurvey: 0, fleetCombat: 0 }} },
{ id: 2, category: 'nationState', flavor: { name: 'Alien Imperium', color: '#e74c3c', nameList: 'default'}, government: { succession: 'monarchy', leaderTermDuration: 0, presentTermEnd: 0, homeSystem: 4 }, resources: { credits: 100, rocks: 0, gas: 0 }, ownedPlanetoids: [401], characters: {characterPool: [], leaderId: null}, parentId: null, childIds: [], diplomacy: {relations: {1: { targetOrgId: 1, status: 'war', opinion: -100 }, 3: { targetOrgId: 3, status: 'war', opinion:-100}}, incomingRequests: [], residentDiplomats: []}, contextHistory: {previousIncome: { credits: 100, rocks: 0, gas: 0 }, buildPlan: [], targetSystems: [] }, research: { researched: [], researchBonuses: { depositSurvey: 0, fleetCombat: 0 }} },
{ id: 3, category: 'nationState', flavor: { name: 'Peace Nation', color: '#e74c3c', nameList: 'default'}, government: { succession: 'monarchy', leaderTermDuration: 0, presentTermEnd: 0, homeSystem: 4 }, resources: { credits: 100, rocks: 0, gas: 0 }, ownedPlanetoids: [401], characters: {characterPool: [], leaderId: null}, parentId: null, childIds: [], diplomacy: {relations: {1: { targetOrgId: 1, status: 'peace', opinion: -100 }, 2: { targetOrgId: 2, status: 'peace', opinion: 100 }}, incomingRequests: [], residentDiplomats: []}, contextHistory: {previousIncome: { credits: 100, rocks: 0, gas: 0 }, buildPlan: [], targetSystems: [] }, research: { researched: [], researchBonuses: { depositSurvey: 0, fleetCombat: 0 }} },
];
